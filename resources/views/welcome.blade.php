            ...
            <div class="row flex-lg-row flex-md-column-reverse">
                <div class="col-xl-5 col-lg-5">
                    <div class="inner-content">
                        <h1 class="title wow fadeInUp" data-wow-delay="200ms" data-wow-duration="800ms">Solusi Pembayaran dan Pembelian Digital</h1>
            ...
            <div class="row">
                <div class="col-xl-4">
                    <div class="content-left-wrapper">
                        ...
                        <a href="about.html" class="sotcox-btn mt-45">more projects <span></span></a>
                    </div>
                </div>
                <div class="col-xl-8">
                            ...
                            <div class="col-xl-6 col-lg-6 col-md-6 col-sm-6 cat-1 cat-4 cat-3 mt-30 grid">
                                <div class="sotcox-project-item">
                                    ...
                                    <div class="content">
                                        ...
                                        <span class="cat">DATA SECURITY</span>
            ...
            <div class="row">
                <div class="col-xl-6">
                    <div class="wcu-img-wrapper">
                        <img src="assets/img/bg/wcu-bg-1.png" alt="">
                    </div>
                </div>
                <div class="col-xl-6">
    ...
    <footer class="sotcox-footer theme-light-bg pt-95">
                ...
                <div class="row mt-none-30">
                    <div class="col-xl-4 col-lg-4 col-md-6 col-sm-6 sotcox-custom-col mt-30">
                        <div class="widget">
                            <div class="about-widget">
                                ...
                                <p><i class="far fa-map-marker-alt"></i> 1791 Yorkshire Circle Kitty</p>
                    ...
                    <div class="col-xl-4 col-lg-4 col-md-6 col-sm-6 sotcox-custom-col mt-30">
                        <div class="widget">
                            ...
                            <ul>
                                <li><a href="service-details.html">Data Analytics</a></li>
                                ...
                                <li><a href="service-details.html">Machine Learning</a></li>
                            </ul>
                        </div>
                    </div>
                    <div class="col-xl-4 col-lg-4 col-md-6 col-sm-6 sotcox-custom-col mt-30">
                        <div class="widget">
                            ...
                            <ul>
                                ...
                                <li><a href="about.html">Refund</a></li>
                                <li><a href="about.html">Terms</a></li>
                                <li><a href="about.html">Privacy Policy</a></li>
                                <li><a href="about.html">Awards & Partners</a></li>
                            </ul>
                        </div>
                    </div>
                </div>
        ...
        <div class="sotcox-copyright">
            <div class="container">
                <div class="row">
                    <div class="col-md-8">
                        <p>Copyright &copy; <span id="copyright-date"></span> Sotcox, All Rights Reserved.</p>
                    </div>
                    <div class="col-md-4">
